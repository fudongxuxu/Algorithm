 ...
 */
 ...
 var catMouseGame = function(graph) {
     this.n = graph.length;
     this.graph = graph;
     this.dp = new Array(n).fill(0).map(() => new Array(n).fill(0).map(() => new Array(2 * n * (n - 1)).fill(-1)));
 ...
 const getResult = (mouse, cat, turns) => {
     ...
     console.log(dp[mouse][cat][turns],[mouse,cat,turns])
 ...
 catMouseGame([[2,5],[3],[0,4,5],[1,4,5],[2,3],[0,2,3]])